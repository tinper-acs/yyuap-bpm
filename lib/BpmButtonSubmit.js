...
var BpmButtonSubmit = function (_Component) {
    ...
    function BpmButtonSubmit() {
        ...
        _this.handlerBtn = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
            var _this$props, checkedArray, data, submitArray, i, _ref2, _ref2$data, success, detailMsg, commitParam, _result, flag, _result2, message;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 14:
                            ...
                            if (flag == "success") {
                                _tinperBee.Message.create({ content: '\u5355\u636E\u63D0\u4EA4\u64CD\u4F5C\u6210\u529F', color: 'success', position: 'top' });
