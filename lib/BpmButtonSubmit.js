...
var BpmButtonSubmit = function (_Component) {
    ...
    function BpmButtonSubmit() {
        ...
        _this.handlerBtn = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
            var _this$props, checkedArray, data, onStart, onSuccess, onError, submitArray, i, _ref2, _ref2$data, success, detailMsg, commitParam, _result, flag, _result2, message;
