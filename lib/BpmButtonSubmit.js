...
var BpmButtonSubmit = function (_Component) {
    ...
    function BpmButtonSubmit() {
        ...
        _this.handlerBtn = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
            var _this$props, checkedArray, onStart, onEnd, onSuccess, onError, submitArray, _ref2, _ref2$data, success, detailMsg, commitParam, _result, flag, _result2, message;
        ...
        _this.huanjieHandlerOK = _asyncToGenerator(_regenerator2.default.mark(function _callee4() {
            var _this$props2, onSuccess, onError, onStart, onEnd, _this$state, processDefineCode, assignInfo, obj, result;

            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            _this$props2 = _this.props, onSuccess = _this$props2.onSuccess, onError = _this$props2.onError, onStart = _this$props2.onStart, onEnd = _this$props2.onEnd;
