...
var propTypes = {
    ...
    axiosType: _propTypes2.default.string };
...
var BpmTable = function (_Component) {
    ...
    function BpmTable() {
        ...
        _this.componentDidMount = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
            var _this$props, processDefinitionId, processInstanceId, axiosType, hisTasklistData;

            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _this$props = _this.props, processDefinitionId = _this$props.processDefinitionId, processInstanceId = _this$props.processInstanceId, axiosType = _this$props.axiosType;
                            _context.next = 3;
                            return (0, _common.sendBpmTaskAJAX)(axiosType, {
