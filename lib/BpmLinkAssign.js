...
var BpmLinkAssign = function (_Component) {
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            onError && onError({
                                type: 2,
                                msg: (0, _intl.getlocals)({ id: "js.b9f.src8.0001", defaultMessage: "请选择单条数据提交" })
                            });
                        ...
                        case 4:
                            ...
                            onError && onError({
                                type: 1,
                                msg: (0, _intl.getlocals)({ id: "js.b9f.src8.0002", defaultMessage: "不能提交此单据，重复提交" })
                            });
                            return _context.abrupt('return');
                        ...
                        case 20:
                            ...
                            if (flag == "success" && typeof _result.data.detailMsg.data.assignAble == 'undefined') {
                                ...
                                onError && onError({
                                    type: 2,
                                    msg: (0, _common.reconvert)(_result.data.message) || (0, _intl.getlocals)({ id: "js.b9f.src8.0003", defaultMessage: "流程启动失败" })
                                });
                            }
                        ...
                        case 26:
                            if (success == "fail_global") {
                                ...
                                onError && onError({
                                    type: 2,
                                    msg: (0, _common.reconvert)(message) || (0, _intl.getlocals)({ id: "js.b9f.src8.0003", defaultMessage: "流程启动失败" })
                                });
                            }
                        ...
                        case 29:
                            onError && onError({
                                type: 1,
                                msg: (0, _intl.getlocals)({ id: "js.b9f.src8.0004", defaultMessage: "请选择提交的单据" })
                            });
                    ...
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            ...
                            return _axios2.default.post(urlAssignSubmit, {
                                ...
                                onError && onError({
                                    type: 2,
                                    msg: (0, _intl.getlocals)({ id: "js.b9f.src8.0005", defaultMessage: "后台服务请求发生错误" })
                                });
                            });
                        ...
                        case 5:
                            ...
                            if (result.data.success == 'success') {
                                ...
                                onError && onError({
                                    type: 2,
                                    msg: (0, _common.reconvert)(result.data.message) || (0, _intl.getlocals)({ id: "js.b9f.src8.0003", defaultMessage: "流程启动失败" })
                                });
                                _this.setState({
                                    huanjieShow: false,
                                    childRefKey: [],
    ...
    _createClass(BpmLinkAssign, [{
        ...
        value: function render() {
            var self = this;
            var huanjieCol = [{
                title: (0, _intl.getlocals)({ id: "js.b9f.src8.0006", defaultMessage: "名称" }),
                dataIndex: "name",
                key: "name"

            }, {
                title: (0, _intl.getlocals)({ id: "js.b9f.src8.0007", defaultMessage: "指派" }),
                dataIndex: "1",
                key: "1",
                ...
                render: function render(text, record, index) {
                    return _react2.default.createElement(_refWithInput2.default, { disabled: false, option: (0, _assign2.default)(JSON.parse(_refOptions2.default), {
                            title: (0, _intl.getlocals)({ id: "js.b9f.src8.0008", defaultMessage: "用户选择" }),
                            backdrop: false,
                            hasPage: true,
                            refType: 2,
                            isRadio: false,
            ...
            return _react2.default.createElement(_tinperBee.Table, {
                ...
                emptyText: function emptyText() {
                    return _react2.default.createElement(
                        'span',
                        null,
                        (0, _intl.getlocals)({ id: "js.b9f.src8.0009", defaultMessage: "暂无环节" })
                    );
                },
