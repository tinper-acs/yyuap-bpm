...
var BpmTaskApproval = function (_Component) {
    ...
    function BpmTaskApproval(props) {
        ...
        _this.handlerSubmitBtn = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
            var _this$props, onStart, onEnd, onSuccess, onError, result, second, _second;
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        ...
                        case 7:
                            ...
                            _context.next = _context.t0 === 'agree' ? 11 : _context.t0 === 'unagree' ? 21 : _context.t0 === 'rejectToActivity' ? 31 : _context.t0 === 'signAdd' ? 33 : _context.t0 === 'delegate' ? 35 : 37;
                            break;
                        ...
                        case 27:
                            _second = _context.sent;

                            onEnd && onEnd();
                            _this.setState({
                                signAddList: _second.data.data.content,
                                signAddShow: true,
                                checkedArray: _second.data.data.content,
                                totalPages: _second.data.data.totalPages
                            });
        ...
        _this.rejectToActivityOK = _asyncToGenerator(_regenerator2.default.mark(function _callee2() {
            var _this$props2, onStart, onEnd, onSuccess, onError, msg;
        ...
        _this.signAddOK = _asyncToGenerator(_regenerator2.default.mark(function _callee3() {
            var _this$props3, onStart, onEnd, onSuccess, onError, agreeArrayObject, msg, unagreeArrayObject;

            return _regenerator2.default.wrap(function _callee3$(_context3) {
                while (1) {
                    switch (_context3.prev = _context3.next) {
                        case 0:
                            _this$props3 = _this.props, onStart = _this$props3.onStart, onEnd = _this$props3.onEnd, onSuccess = _this$props3.onSuccess, onError = _this$props3.onError;
                            _context3.t0 = _this.state.approvetype;
                            _context3.next = _context3.t0 === 'agree' ? 4 : _context3.t0 === 'unagree' ? 12 : _context3.t0 === 'signAdd' ? 20 : 26;
                            break;

                        case 4:
                            agreeArrayObject = [];

                            if (Array.isArray(_this.state.userIds)) {
                                agreeArrayObject = (0, _from2.default)(_this.state.userIds, function (x) {
                                    return { id: x };
                                });
                            }
                            onStart && onStart();
                            _context3.next = 9;
                            return _axios2.default.post('/eiap-plus/task/assigntask/commit', {
                        ...
                        case 12:
                            ...
                            if (Array.isArray(_this.state.userIds)) {
                                unagreeArrayObject = (0, _from2.default)(_this.state.userIds, function (x) {
                                    return { id: x };
                                });
                            }
                            onStart && onStart();
        ...
        _this.delegatedOK = _asyncToGenerator(_regenerator2.default.mark(function _callee4() {
            var _this$props4, onStart, onEnd, onSuccess, onError, msg;

            return _regenerator2.default.wrap(function _callee4$(_context4) {
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        case 0:
                            _this$props4 = _this.props, onStart = _this$props4.onStart, onEnd = _this$props4.onEnd, onSuccess = _this$props4.onSuccess, onError = _this$props4.onError;
