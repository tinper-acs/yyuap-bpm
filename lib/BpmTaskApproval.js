...
var _index = require('pap-refer/lib/pap-common-table/src/index.js');

var _index2 = _interopRequireDefault(_index);

var _index3 = require('pap-refer/lib/pap-common-treeTransfer/src/index.js');
                    ...
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            return (0, _common.sendBpmTaskAJAX)('rejectToBillMaker', {
                                ...
                                _tinperBee.Message.create({ content: '' + e.toString(), color: 'danger', position: 'top', duration: 15 });
                                onError && onError({
                                    type: 2,
                                    msg: '\u670D\u52A1\u5668\u8BF7\u6C42\u9519\u8BEF'
                                });
                    ...
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 3:
                            ...
                            if (result.data.flag == 'success' && result.data.rejectlist.length > 0) {
                                ...
                                _tinperBee.Message.create({ content: result.data.msg || '当前环节为首环节，没有可以驳回的环节', color: 'warning', position: 'top', style: { animation: 'none' } });
                                onError && onError({
                                    type: 2,
                    ...
                    this.props.appType == "1" && _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                this.state.approvetype === "signAdd" && _react2.default.createElement(_index4.default, assignOption),
                                this.state.approvetype === "delegate" && _react2.default.createElement(_index2.default, option),
