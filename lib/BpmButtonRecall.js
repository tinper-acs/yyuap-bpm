...
var BpmButtonRecall = function (_Component) {
    ...
    function BpmButtonRecall() {
        ...
        _this.handlerBtn = _asyncToGenerator(_regenerator2.default.mark(function _callee() {
            var _this$props, checkedArray, data, onStart, onSuccess, onError, recallArray, i, _ref2, _ref2$data, success, detailMsg;
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            for (i = 0; i < checkedArray.length; i++) {
                                if (checkedArray[i].bpmState != 0) {
                                    ...
                                    _tinperBee.Message.create({ content: '\u672A\u63D0\u4EA4,\u4E0D\u80FD\u6267\u884C\u64A4\u56DE\u64CD\u4F5C', color: 'danger', position: 'top' });
                        ...
                        case 14:
                            _tinperBee.Message.create({ content: '\u8BF7\u9009\u62E9\u5355\u636E\u540E\u64A4\u56DE', color: 'info', position: 'top' });
                            onError && onError();
