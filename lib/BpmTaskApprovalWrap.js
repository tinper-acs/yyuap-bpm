...
var _index = require('pap-refer/lib/pap-common-treeTransfer/src/index.js');

require('pap-refer/dist/index.css');
...
var BpmTaskApprovalWrap = function (_Component) {
    ...
    function BpmTaskApprovalWrap() {
        ...
        _this.handlerSubmitBtn = _asyncToGenerator(_regenerator2.default.mark(function _callee2() {
            var _this$props, onStart, onEnd, onSuccess, onError, result, _this$state, activityId, approvetype, comment, processInstanceId, taskId, rejectToBillMakerMsg, signAddMsg, delegateMsg, res, rejectres;
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        ...
                        case 4:
                            onStart && onStart();
                            _context2.t0 = _this.state.approvetype;
                            _context2.next = _context2.t0 === 'agree' ? 8 : _context2.t0 === 'unagree' ? 8 : _context2.t0 === 'rejectToActivity' ? 14 : _context2.t0 === 'signAdd' ? 24 : _context2.t0 === 'delegate' ? 34 : _context2.t0 === 'withdraw' ? 44 : _context2.t0 === 'rejectToBillMaker' ? 49 : 54;
                            break;
                        ...
                        case 21:
                            rejectToBillMakerMsg = _context2.sent;
    ...
    _createClass(BpmTaskApprovalWrap, [{
        ...
        value: function render() {
            ...
            var assignOption = {
                ...
                param: {
                    refCode: 'neworgdeptuser_treegrid' },
                refModelUrl: {
                ...
                onSave: function () {
                    var _ref3 = _asyncToGenerator(_regenerator2.default.mark(function _callee3(sels) {
                        var agreeeMsg;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_index.RefTreeTransfer, _extends({}, assignOption, { showModal: this.state.showModal }))
            );
        }
    }]);
